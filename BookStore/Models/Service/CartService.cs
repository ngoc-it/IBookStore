...
namespace BookStore.Models.Service
{
    public class CartService : BaseService<Cart>, ICartService
    {
        ...
        public async Task<PagingModel<OrderViewModel>> GetPagingOrder(Enumerations.OrderStatus status, int? pageIndex, int? userId = null)
        {
        ...
        public async Task UpdateOrderStatus(int orderId, Enumerations.OrderStatus status)
        {
            var order = await _orderService.GetEntityById(orderId);
